...
| 0005 | DBWD Rate Ownership | Accepted | Data Platform owns rate snapshots, refresh fixtures, and optional Redis caching; Compliance Core owns deterministic in-memory matching for the offline path. Live cross-service rate retrieval remains an explicit integration boundary. |
