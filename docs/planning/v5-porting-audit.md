...
**Historical snapshot (2026-06-19):** This audit is a historical V3/V4-to-V5 inventory. At that snapshot, verification was 274 unit tests, 24 Data Platform integration tests, and 93 Compliance Core eval tests (92 examples plus one baseline regression). The Agent then used Mastra workflows/tools and persisted decisions only through Data Platform `/internal/decisions`.
